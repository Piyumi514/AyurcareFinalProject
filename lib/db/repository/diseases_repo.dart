...
class DiseasesRepo {
  ...
  //     "disease": "Asthma (ඇදුම",
  //     'details':
  //         'Ginger has anti-inflammatory properties that can help reduce airway inflammation. To make ginger tea, simmer fresh ginger slices in water for about 10 minutes, strain, and add honey or lemon for flavor.',
  //     'name': 'Ginger Tea'
  //   },
  //   {
  ...
  //     "disease": "Asthma (ඇදුම",
  //     'details':
  //         ' Turmeric is known for its anti-inflammatory and antioxidant properties. Mix a teaspoon of turmeric powder into a glass of warm milk and drink it before bedtime to help reduce asthma symptoms.Steam Inhalation: Inhaling steam can help open up the airways and clear mucus. Boil water in a pot, remove from heat, and lean over the pot with a towel covering your head to trap the steam. Breathe deeply for several minutes.',
  //     'name': 'Turmeric Milk'
  //   },
  //   {
  //     'url': 'assets/homeremedies/Honey and Cinnamon.jpg',
  //     "disease": "Asthma (ඇදුම",
  //     'details':
  //         ' Mix a teaspoon of honey with a pinch of cinnamon. Consuming this mixture daily can help soothe the throat and reduce inflammation. ',
  ...
  //     'details':
  //         'Ginger has natural anti-inflammatory and antiviral properties that can help soothe a sore throat and reduce congestion. To make ginger tea, simmer fresh ginger slices in water for about 10 minutes, strain, and add honey or lemon for flavor.',
  //     'name': 'Ginger Tea'
  //   },
  //   {
  //     'url': 'assets/homeremedies/Turmeric Milk.jpg',
  //     "disease": "Common cold (සෙම්ප්‍රතිශ්‍යාව)",
  //     'details':
  //         'Turmeric is known for its antimicrobial properties. Mix a teaspoon of turmeric powder into a glass of warm milk and drink it before bedtime to relieve cold symptoms. ',
  //     'name': 'Turmeric Milk'
  //   },
  //   {
  //     'url': 'assets/homeremedies/Steam Inhalation.jpg',
  //     "disease": "Common cold (සෙම්ප්‍රතිශ්‍යාව)",
  //     'details':
  //         ' Inhaling steam can help clear nasal congestion and soothe irritated sinuses. Boil water in a pot, remove from heat, and lean over the pot with a towel covering your head to trap the steam. Breathe deeply for several minutes. ',
  //     'name': 'Steam Inhalation'
  //   },
  //   {
  //     'url': 'assets/homeremedies/Honey and Lemon.jpg',
  //     "disease": "Common cold (සෙම්ප්‍රතිශ්‍යාව)",
  //     'details':
  //         'Mix a tablespoon of honey with freshly squeezed lemon juice in warm water. This mixture can help soothe a sore throat and boost the immune system. ',
  ...
  //       final byteData = await rootBundle.load(item["url"] ?? "");
  //
  ...
  Future<DiseasesModel?> getDiseaseByName(String name) async {
    try {
      QuerySnapshot querySnapshot = await _diseasesCollection
          .where("diseases_name", isEqualTo: name)
          .get();
      final li = querySnapshot.docs
          .map((doc) => DiseasesModel.fromFirestore(doc))
          .toList();
      return li.first;
    } catch (e) {
